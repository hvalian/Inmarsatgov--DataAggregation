...
SELECT [id]
	  ...
	  ,activationDate
	  ,deactivationDate
    FROM [MSCDEV].[igenms_msc].[dbo].[vwNode]
...
SELECT [id]
    ...
    FROM [MSCDEV].[igenms_msc].[dbo].[vwNodeMetric]
    WHERE [nodeTypeId]  IN ('10', '17')
GO
...
SELECT [id]
      ...
      ,[isbackFilled]
    FROM [MSCDEV].[igenms_msc].[dbo].[tbNodeMetricValue]
    WHERE [nodeTypeId]  IN ('10', '17')
GO
...
SELECT P.[id]
      ...
      ,P.[dateCreated]
      ,P.[dateUpdated]
    FROM [MSCDEV].[igenms_msc].[dbo].[tbNodeParent] P Inner Join
        [MSCDEV].[igenms_msc].[dbo].[vwNode] N on P.[nodeId] = N.[id]
...
SELECT [id]
    ...
    FROM [MSCDEV].[igenms_msc].[dbo].[vwNodeType]
    WHERE [id] IN ('10', '17')
GO
...
SELECT [id]
    ...
    FROM [MSCDEV].[igenms_msc].[dbo].[vwNodeTypeMetric]
    WHERE [nodeTypeId]  IN ('10', '17')
GO
